import { getData } from "../../../core/configs/DataUtils";
...
export function getFrameInfo(data: any): FrameInfo {
    ...
    let f: FrameInfo = getData(data, keys, def);
    if (+f.e == 0) {
        f.e = undefined;
    }
 ...
 * @returns
 */
export function getActionInfo(data: any, key: number) {
