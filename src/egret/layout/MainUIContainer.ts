import { getFixedLayout, LayoutType, Layout, getLayoutPos } from "../../core/layout/Layout";
import { LayoutContainer, LayoutBin } from "./LayoutContainer";
...
export class MainUIContainer extends LayoutContainer {
    ...
    public add(d: egret.DisplayObject, type: LayoutType, offsetRect?: egret.Rectangle, hide?: boolean) {
        ...
        let result = getLayoutPos(raw.width, raw.height, offsetRect.width, offsetRect.height, type);
