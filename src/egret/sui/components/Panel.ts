import { AsyncHelper } from "../../../core/mvc/async/AsyncHelper";
import { IAsync } from "../../../core/mvc/async/IAsync";
import { toggle, ToggleState } from "../../../core/mvc/core/Facade";
import { FHost } from "../../../core/mvc/core/FHost";
import { Callback } from "../../../core/utils/Callback";
import { singleton } from "../../../core/utils/ClassUtils";
import { expand } from "../../../core/utils/Mixin";
import { getTexture } from "../../texture/ColorTexture";
...
export class Panel extends egret.Sprite implements SuiDataCallback, IAsyncPanel {
    ...
    public suiDataComplete(suiData: SuiData) {
        if (this.preloadImage) {
            suiData.loadBmd(Callback.get(this.loadNext, this));
        } else {
            this.loadNext();
        }
    }
    ...
    protected bindComponent() {
        createSuiComponents(this.suiLib, this.suiClass, this);
    }
