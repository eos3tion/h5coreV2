...
import { BaseData, ComponentData, getSuiElement, initSuiBaseData, SizeData } from "./SuiResManager";
...
export class BaseCreator<T extends egret.DisplayObject> {
    ...
    public createElement(data: ComponentData) {
        return getSuiElement(this._suiData, data);
    }
    ...
    public get(): T {
        ...
        if (this._baseData) {
            initSuiBaseData(t, this._baseData);
        }
        return t;
    }
