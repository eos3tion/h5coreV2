...
import { Callback, $Callback } from "../../../core/utils/Callback";
...
import { SuiBmd } from "./SuiBmd";
import { PanelsData, SourceComponentDataDict, SuiResConst, getSuiDataUri } from "./SuiResManager";
...
export class SuiData {
    ...
    noRes(uri: string, file: string, textures: egret.Texture[]) {
        let url = ConfigUtils.getSkinFile(this.key, file) + App.webpExt;
    ...
    public loadBmd<T extends Function>(callback?: Callback<T>) {
