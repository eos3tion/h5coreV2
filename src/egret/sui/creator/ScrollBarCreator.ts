...
import { ScaleBitmap } from "./ScaleBitmapCreator";
...
export class ScrollBarCreator extends BaseCreator<ScrollBar>{
    ...
    private createScrollBar(): ScrollBar {
        ...
        let sc = createSuiDisplay(this._suiData.key, name, tmpData[1]) as ScaleBitmap;
        ...
        sourceArr = sourceData[5];
        name = sourceArr[0][index];
        sc = createSuiDisplay(this._suiData.key, name, tmpData[1]) as ScaleBitmap;
        scrollBar.setBg(sc);
