...
import { Bin, BinPacker } from "../../core/utils/binpacker/BinPacker";
...
export function getTextureSheet(size: number = TextureSheetConst.DefaultSize, canvas?: HTMLCanvasElement) {
    canvas = canvas || App.getCanvas();//canvas作为可传入，避免如“小程序”或其他环境，需要通过其他方法创建canvas
